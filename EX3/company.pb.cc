...
const ::uint32_t TableStruct_company_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    ...
    PROTOBUF_FIELD_OFFSET(::Company, _impl_.line_),
    PROTOBUF_FIELD_OFFSET(::Company, _impl_.fea_),
    3,
    0,
    1,
    2,
...
class Company::_Internal {
 public:
  ...
  static void set_has_fea(HasBits* has_bits) {
    (*has_bits)[0] |= 16u;
  }
...
Company::Company(const Company& from)
  ...
  ::memcpy(&_impl_.year_, &from._impl_.year_,
    static_cast<::size_t>(reinterpret_cast<char*>(&_impl_.fea_) -
    reinterpret_cast<char*>(&_impl_.year_)) + sizeof(_impl_.fea_));
...
// @@protoc_insertion_point(message_clear_start:Company)
  ...
  if (cached_has_bits & 0x00000018u) {
    ::memset(&_impl_.year_, 0, static_cast<::size_t>(
        reinterpret_cast<char*>(&_impl_.fea_) -
        reinterpret_cast<char*>(&_impl_.year_)) + sizeof(_impl_.fea_));
  }
    ...
    switch (tag >> 3) {
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 34)) {
          ...
          CHK_(ptr);
          #ifndef NDEBUG
          ::_pbi::VerifyUTF8(str, "Company.line");
          #endif  // !NDEBUG
        } else {
          goto handle_unusual;
        }
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 40)) {
          _Internal::set_has_fea(&has_bits);
          _impl_.fea_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else {
          goto handle_unusual;
        }
...
void Company::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (cached_has_bits & 0x0000001fu) {
    ...
    if (cached_has_bits & 0x00000010u) {
      _this->_impl_.fea_ = from._impl_.fea_;
    }
